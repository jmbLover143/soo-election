            ...
            <!-- START -->
                ...
                <div class="" style="float: left">
                    <table style=";box-shadow:10px 10px 10px   #888888;margin-top: -70px;border: 1px solid black;">
                        <tr>
                            <td><button class="btn btn-info" style="width:300px"><B>MITZH NATHALIE YUDAI</B></button></td>
                        </tr>
                        <tr>
                            <td><img style="height:400px;border:1px solid black;width:300px;margin-left: 5px;" src="lib/soo/yudai.jpg"/></td>
                        </tr>
                        <tr>
                     ...
                     <table style="margin-left: 390px;border: 1px solid black;margin-top: -510px;box-shadow:10px 10px 10px   #888888;">
                        <tr>
                            <td><button class="btn btn-warning" style="width:300px"><B>ROLAN OSITA</B></button></td>
                        </tr>
                        <tr>
                            <td><img style="height:400px;border:1px solid black;width:300px;margin-left: 5px;" src="lib/like/osita.jpg"/></td>
                        </tr>
                        <tr>
                     ...
                     <div style="width:300px;float: right;background-color:  white;margin-right: 120px; " class="col-6 col-md-6 col-lg-6">
                        <div class="grey lighten-3 z-depth-2" style="width: 300px;background-color:  white;; height: 300px;">
                            ...
                            <form action="audit.php" method="POST">
                                        ...
                                        <select name="audit" style="background-color: white;font-size: 50px;text-align-last:center;">
                                            <option name="audit" style="background-color: white;font-size: 50px;text-align: center" ><h3 style="text-align: center"> </h3></option>
                                            <option name="audit" style="background-color: white;font-size: 50px;text-align: center"><center>MITZH NATHALIE YUDAI</center></option>
                                            <option name="audit" style="background-color: white;font-size: 50px;text-align: center">ROLAN OSITA</option>                                           
                                        </select>
                                    <center>
