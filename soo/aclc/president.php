    ...
    <header class="hidden_this">
        ...
        <nav class="navbar navbar-toggleable-md navbar-expand-lg scrolling-navbar double-nav" style="background: #0277BD;">
            ...
            <div class="float-left">
                <a href="" data-activates="slide-out" class="button-collapse"><img src="lib/images/ACLC LOGO2.png" width="60px" width="35px" style="padding: 0; margin: 0;height: 30px;"></a>
            </div>
            <!-- Breadcrumb-->
            <div class="breadcrumb-dn mr-auto" style="float: left; padding: 0; margin: 0;">
                <p><b style="font-size: 15px;">ACLC COLLEGE OF MARIKINA</b></p>
                
            </div>
            <div class=" " style="float: right; padding: 0; margin-right: 170px;;">
                <p><b style="font-size: 15px;">SOO ELECTION 2019</b></p>
            ...
            <!-- START -->
                ...
                <div class="" style="float: left;margin-left: 150px;">
                    <table style=";box-shadow:10px 10px 10px   #888888;margin-top: -70px;border: 1px solid black;">
                        <tr>
                            <td><button class="btn btn-info" style="width:300px"><b>JOHN HENRY SALANSAN</b></button></td>
                        </tr>
                        <tr>
                            <td><img style="height:400px;border:1px solid black;width:300px;margin-left: 5px;" src="lib/soo/salansan.jpg"/></td>
                        </tr>
                        <tr>
                     ...
                     <table style="margin-left: 390px;border: 1px solid black;margin-top: -510px;box-shadow:10px 10px 10px   #888888;">
                        <tr>
                            <td><button class="btn btn-warning" style="width:300px"><b>PAULA ISRAEL RITO</b> </button></td>
                        </tr>
                        <tr>
                            <td><img style="height:400px;border:1px solid black;width:300px;margin-left: 5px;" src="lib/like/rito.jpg"/></td>
                        </tr>
                        <tr>
                    ...
                    <!-- END OF COL-6 -->
                    <center style="margin-right: -0px;margin-top:100px;">
                    ...
                    <div style="width:300px;float: right;background-color:  white;margin-right: 120px; " class="col-6 col-md-6 col-lg-6">
                        <div class="grey lighten-3 z-depth-2" style="width: 300px;background-color:  white;; height: 300px;">
                            ...
                            <form name="" action="insert_score.php" method="POST" onsubmit="validate()">
                         
                                        <select name="vote" style="background-color: white;font-size: 50px;text-align-last:center;">
                                            <option  style="background-color: white;font-size: 50px;text-align: center"><h3 style="text-align: center"> </h3></option>
                                            <option name="vote" style="background-color: white;font-size: 50px;text-align: center" ><center>JOHN HENRY SALANSAN</center></option>
                                            <option name="vote" style="background-color: white;font-size: 50px;text-align: center">PAULA ISRAEL RITO</option>                                           
                                        </select>
                                    <center>


                                        <!-- Button trigger modal -->
<button type="button" name="" class="btn btn-success" data-toggle="modal" data-target="#exampleModalCenter">
  Submit vote</button>
