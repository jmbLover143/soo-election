            ...
            <!-- START -->
                ...
                <div style="border: 1px solid black;margin: 0 auto;width:800px;float: left;margin-top: -95px;height: 708px;margin-left: 150px;">
                    <table style="margin: 0 auto;width:1090px;height:590px;float:left">
                        <thead><center><button class="btn btn-info" style="width:300px;float: left; height:35px;">MARICEL TAYCO</button><button class="btn btn-warning" style="height:35px;width:300px;float: right;">HANNA CARCAMO</button></center></thead>
                        <tr>
                            <td><img style="height:300px;border:1px solid black;width:300px;margin-left: 5px;margin-top: 0px;" src="lib/soo/tayco.jpg"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<img style="height:300px;border:1px solid black;width:300px;margin-left: 5px;margin-top:  0px;" src="lib/like/hannah.jpg"/></td>
                        </tr>
                        <tr>
                            <td><center><button class="btn btn-info" style="width:300px;float: left; height:35px;">JUNE NICOLE DELA CRUZ</button><button class="btn btn-warning" style="height:35px;width:300px;margin-left: -119px;">RUSSEL PEÑA</button></center> 
</td>
                        </tr>
                        
                        <tr>
                            <td><img style="height:300px;border:1px solid black;width:300px;margin-left: 5px; " src="lib/soo/cruz.jpg"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<img style="height:300px;border:1px solid black;width:300px;margin-left: 5px;margin-top:  0px;" src="lib/like/pena.jpg"/></td>
                        </tr>
                    </table>
                        ...
                        <div class="grey lighten-3 z-depth-2" style="width: 200px;background-color:  white;; height: 390px;margin-bottom: -20px;">
                            <div class="jumbotron">
                             ...
                             <center>
                                 ...
                                 <button class="btn btn-danger">Select 2nd CBA Candidate</button>
                                 </center>
                            <form action="cba2.php" method="POST" >
                                <input type="hidden" name="cba2" value="<?php echo $user = $_REQUEST['vote'] ?>"/>
                        
                                        <select name="cba1" style="background-color: white;font-size: 50px;text-align-last:center;">
                                            <option name="cba1" style="background-color: white;font-size: 50px;text-align: center" ><h3 style="text-align: center"> </h3></option>
                                            <option name="cba1" style="background-color: white;font-size: 50px;text-align: center"><center>JUNE NICOLE DELA CRUZ</center></option>
                                            <option name="cba1" style="background-color: white;font-size: 50px;text-align: center">MARICEL TAYCO</option>                 
                                            <option name="cba1" style="background-color: white;font-size: 50px;text-align: center"><center>HANNA CARCAMO</center></option>
                                            <option name="cba1" style="background-color: white;font-size: 50px;text-align: center">RUSSEL PEÑA</option>                 
