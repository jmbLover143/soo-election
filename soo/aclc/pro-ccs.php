            ...
            <!-- START -->
                ...
                <div style="border: 1px solid black;margin: 0 auto;width:800px;float: left;margin-top: -95px;height: 708px;margin-left: 150px;">
                    <table style="margin: 0 auto;width:1090px;height:590px;float:left">
                        <thead><center><button class="btn btn-info" style="width:300px;float: left; height:35px;"><B>EMMAN PUNSALAN</B></button><button class="btn btn-warning" style="height:35px;width:300px;float: right;"><B>JEN COLMINAS</B></button></center></thead>
                        <tr>
                        ...
                        <hr/>
                        <tr >
                            <td><center><button class="btn btn-info" style="width:300px;float: left; height:35px;"><B>RYAN RAYOS</B></button><button class="btn btn-warning" style="height:35px;width:300px;margin-left: -119px;"><B>LUIS IMPERIAL</B></button></center> 
</td>
                        </tr>
                        ...
                        <div class="grey lighten-3 z-depth-2" style="width: 200px;background-color:  white;; height: 390px;margin-bottom: -20px;">
                            <div class="jumbotron">
                             ...
                             <center>
                                 ...
                                 <button class="btn btn-danger">Select 1st CCS Candidate</button>
                                 </center>
