    ...
    <header class="hidden_this">
        ...
        <nav class="navbar navbar-toggleable-md navbar-expand-lg scrolling-navbar double-nav" style="background: #0277BD;">
            ...
            <div class="float-left">
                <a href="#" data-activates="slide-out" class="button-collapse"><img src="lib/images/ACLC LOGO2.png" width="60px" width="35px" style="padding: 0; margin: 0;height: 30px;" style="padding: 0; margin: 0;"></a>
            </div>
            <!-- Breadcrumb-->
    ...
    <main class="hidden_this" style="margin-top: 0; padding-top: 0; top: 0;">
        <div class="container-fluid mt-4" style="margin-top: 0; padding-top: 0; top: 0; width: 100%; margin-left: 0;">
            <!-- START -->
                ...
                <div style="border: 1px solid black;margin: 0 auto;width:800px;float: left;margin-top: -95px;height: 708px;margin-left: 150px;">
                    <table style="margin: 0 auto;width:1090px;height:590px;float:left">
                        <thead><center><button class="btn btn-info" style="width:300px;float: left; height:35px;">EMMAN PUNSALAN</button><button class="btn btn-warning" style="height:35px;width:300px;float: right;">JEN COLMINAS</button></center></thead>
                        <tr>
                            <td><img style="height:300px;border:1px solid black;width:300px;margin-left: 5px;margin-top: 0px;" src="lib/soo/punsalan.jpg"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<img style="height:300px;border:1px solid black;width:300px;margin-left: 5px;margin-top:  0px;" src="lib/like/colminas.jpg"/></td>
                        </tr>
                        <tr>
                            <td><center><button class="btn btn-info" style="width:300px;float: left; height:35px;">RYAN RAYOS</button><button class="btn btn-warning" style="height:35px;width:300px;margin-left: -119px;">LUIS IMPERIAL</button></center> 
</td>
                        </tr>
                        
                        <tr>
                            <td><img style="height:300px;border:1px solid black;width:300px;margin-left: 5px; " src="lib/soo/rayos.jpg"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<img style="height:300px;border:1px solid black;width:300px;margin-left: 5px;margin-top:  0px;" src="lib/like/imperial.jpg"/></td>
                        </tr>
                    </table>
                    ...
                    <div style="width:300px;float: right;background-color:  white;padding-right: 110px;" class="col-6 col-md-6 col-lg-6">
                        <div class="grey lighten-3 z-depth-2" style="width: 200px;background-color:  white;; height: 390px;margin-bottom: -20px;">
                            <div class="jumbotron">
                               
                                <h1>PRO CCS</h1>                   
                            </div>
                             <center>
                                 <button class="btn btn-danger">Invalid duplicate vote.</button>
                                 <button class="btn btn-danger">Select another candidate</button>
                                 </center>
                            <form action="ccs3.php" method="POST" >
                                <input type="hidden" name="ccs2" value="<?php echo $user = $_REQUEST['vote'] ?>"/>
                                    
                                       <select name="ccs3" style="background-color: white;font-size: 50px;text-align-last:center;">
                                            <option name="ccs3" style="background-color: white;font-size: 50px;text-align: center" ><h3 style="text-align: center"> </h3></option>
                                            <option name="ccs3" style="background-color: white;font-size: 50px;text-align: center"><center>EMMAN PUNSALAN</center></option>
                                            <option name="ccs3" style="background-color: white;font-size: 50px;text-align: center">JEN COLMINAS</option> 
                                             <option name="ccs3" style="background-color: white;font-size: 50px;text-align: center">RYAN RAYOS<center></center></option>
                                            <option name="ccs3" style="background-color: white;font-size: 50px;text-align: center">LUIS IMPERIAL</option> 
                                        </select>
                                <center>
