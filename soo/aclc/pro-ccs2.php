            ...
            <!-- START -->
                ...
                <div style="border: 1px solid black;margin: 0 auto;width:800px;float: left;margin-top: -95px;height: 708px;margin-left: 150px;">
                    <table style="margin: 0 auto;width:1090px;height:590px;float:left">
                        <thead><center><button class="btn btn-info" style="width:300px;float: left; height:35px;">RYAN RAYOS</button><button class="btn btn-warning" style="height:35px;width:300px;float: right;">LUIS IMPERIAL</button></center></thead>
                        <tr>
                            <td><img style="height:300px;border:1px solid black;width:300px;margin-left: 5px;margin-top: 0px;" src="lib/soo/rayos.jpg"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<img style="height:300px;border:1px solid black;width:300px;margin-left: 5px;margin-top:  0px;" src="lib/like/imperial.jpg"/></td>
                        </tr>
                        <tr>
                            <td><center><button class="btn btn-info" style="width:300px;float: left; height:35px;">EMMAN PUNSALAN</button><button class="btn btn-warning" style="height:35px;width:300px;margin-left: -119px;">JEN COLMINAS</button></center> 
</td>
                        </tr>
                        
                        <tr>
                            <td><img style="height:300px;border:1px solid black;width:300px;margin-left: 5px; " src="lib/soo/punsalan.jpg"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<img style="height:300px;border:1px solid black;width:300px;margin-left: 5px;margin-top:  0px;" src="lib/like/colminas.jpg"/></td>
                        </tr>
                    </table>
                        ...
                        <div class="grey lighten-3 z-depth-2" style="width: 200px;background-color:  white;; height: 390px;margin-bottom: -20px;">
                            <div class="jumbotron">
                             ...
                             <center>
                                 ...
                                 <button class="btn btn-danger">Select 2nd CCS Candidate</button>
                                 </center>
                            <form action="ccs2.php" method="POST" >
                                <input type="hidden" name="ccs2" value="<?php echo $user = $_REQUEST['vote'] ?>"/>
                                    
                                       <select name="ccs1" style="background-color: white;font-size: 50px;text-align-last:center;">
                                            <option name="ccs1" style="background-color: white;font-size: 50px;text-align: center" ><h3 style="text-align: center"> </h3></option>
                                            <option name="ccs1" style="background-color: white;font-size: 50px;text-align: center"><center>EMMAN PUNSALAN</center></option>
                                            <option name="ccs1" style="background-color: white;font-size: 50px;text-align: center">JEN COLMINAS</option> 
                                             <option name="ccs1" style="background-color: white;font-size: 50px;text-align: center">RYAN RAYOS<center></center></option>
                                            <option name="ccs1" style="background-color: white;font-size: 50px;text-align: center">LUIS IMPERIAL</option> 
                                        </select>
                                <center>
