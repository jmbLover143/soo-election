            ...
            <!-- START -->
                ...
                <div class="" style="float: left;margin-left: 100px;">
                    <table style=";box-shadow:10px 10px 10px   #888888;margin-top: -70px;border: 1px solid black;">
                        <tr>
                            <td><button class="btn btn-info" style="width:300px"><b>DORITHY JOYCE PARILLA</b></button></td>
                        </tr>
                        <tr>
                            <td><img style="height:400px;border:1px solid black;width:300px;margin-left: 5px;" src="lib/soo/parilla.jpg"/></td>
                        </tr>
                        <tr>
                     ...
                     <table style="margin-left: 390px;border: 1px solid black;margin-top: -510px;box-shadow:10px 10px 10px   #888888;">
                        <tr>
                            <td><button class="btn btn-warning" style="width:300px"><B>JIMWELL JUANITO</B></button></td>
                        </tr>
                        <tr>
                            <td><img style="height:400px;border:1px solid black;width:300px;margin-left: 5px;" src="lib/like/juanito.jpg"/></td>
                        </tr>
                        <tr>
                   ...
                   <div style="width:300px;float: right;background-color:  white;margin-right: 120px; " class="col-6 col-md-6 col-lg-6">
                        <div class="grey lighten-3 z-depth-2" style="width: 300px;background-color:  white;; height: 300px;">
                            ...
                            <form action="tre.php" method="POST">
                                        ...
                                        <select name="tre" style="background-color: white;font-size: 50px;text-align-last:center;">
                                            <option name="tre" style="background-color: white;font-size: 50px;text-align: center" ><h3 style="text-align: center"> </h3></option>
                                            <option name="tre" style="background-color: white;font-size: 50px;text-align: center"><center>DORITHY JOYCE PARILLA</center></option>
                                            <option name="tre" style="background-color: white;font-size: 50px;text-align: center">JIMWELL JUANITO</option>                                           
                                        </select>
                                    <center>
